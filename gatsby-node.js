              ...
              node {
                ...
                contents.forEach((entry) => {
                    ...
                    if (!mainNavigation.length) {
                        throw new Error('The global navigation item has not been found. Please create a content item with the content type MainNav in Storyblok.')
                    }
                    ...
                    if(entry.node.full_slug == 'publications') {
                        story.articles = contents.filter(item => item.node.field_component === 'article');
                        console.log(story)
                    }
